...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cpwt1atw4zxq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mustaablog' # please enter your s3 bucket name
